...
Mit sehr wenig Aufwand können durch diese Methode während der Entwicklung grobe Nutzungsprobleme beseitigt werden.
...
\begin{table}[h!]
 ...
 \end{tabular}
 \caption{Beispieltabelle mit Linien}
 \label{tab:klm}
\end{table}
...
\begin{table}[h!]
		\begin{tabular}{|l|c|c|c|c|c|c|}
			...
			\hline
		\end{tabular}
		\caption{Gütekriterien von Evaluationsmethoden \cite[S. 225]{Ullenboom2014}}
...
\begin{figure}[H]
 \centering
 \includegraphics[width=0.2999\textwidth]{grafiken/scenegraph.png}
...
\begin{figure}[H]
 \centering
 \includegraphics[width=0.2999\textwidth]{grafiken/scenegraph2.png}
...
\begin{figure}[H]
 \centering
 \includegraphics[width=0.6\textwidth]{grafiken/event_phase.png}
